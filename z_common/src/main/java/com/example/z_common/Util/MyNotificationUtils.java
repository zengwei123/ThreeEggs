...
public class MyNotificationUtils {
    ...
    private static NotificationCompat.Builder getNotificationBuilder(Context mContext,String title, String content, String channelId) {
        ...
        return new NotificationCompat.Builder(mContext,channelId).setAutoCancel(true)
                ...
                .setContentText(content).setSmallIcon(R.mipmap.circle_userimage);
